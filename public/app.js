...
var $author$project$Main$init = _Utils_Tuple2(0, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$Moins = {$: 'Moins'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$Moins)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-')
