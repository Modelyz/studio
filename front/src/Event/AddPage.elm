...
init s f =
    let
        ...
        adding =
            ...
            , uuid = newUuid
            , seed = newSeed
            , identifiers = initIdentifiers s.state.events s.state.eventTypes s.state.identifierTypes hereType Nothing newUuid
    ...
    ( f.uuid
        ...
        |> Maybe.map
            (\t ->
                ...
                in
                { adding
                    | flatselect = H.find s.state.eventTypes t.type_
                    , uuid = t.uuid
                    , identifiers =
