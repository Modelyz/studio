...
match route =
    case route of
        Route.Entity Route.EventType Route.Add ->
            Just { route = route, uuid = Nothing }

        Route.Entity Route.EventType (Route.Edit uuid) ->
            ...
            case validate model of
                Ok h ->
                    ...
                    , Effect.batch
                        ...
                        , Effect.fromCmd <| redirect s.navkey <| Route.Entity Route.EventType (Route.View (Uuid.toString model.uuid))
                        ]
                    )
