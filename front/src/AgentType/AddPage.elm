...
match route =
    case route of
        Route.Entity Route.AgentType Route.Add ->
            Just { route = route, uuid = Nothing }

        Route.Entity Route.AgentType (Route.Edit uuid) ->
            ...
            case validate model of
                Ok h ->
                    ...
                    , Effect.batch
                        ...
                        , Effect.fromCmd <| redirect s.navkey <| Route.Entity Route.AgentType (Route.View (Uuid.toString model.uuid))
                        ]
                    )
