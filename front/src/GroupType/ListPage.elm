            ...
            flatContainer s
                ...
                [ wrappedRow
                    ...
                    [ table [ width fill, Background.color color.table.inner.background ]
                        ...
                        , columns =
                            List.map tableColumn <| List.filter (\it -> Scope.containsScope s.state.groups s.state.groupTypes it.applyTo (HasType (Type.HType HType.GroupType))) <| Dict.values s.state.identifierTypes
                        }
                    ]
                ]
