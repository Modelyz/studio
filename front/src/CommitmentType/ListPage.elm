        ...
        Smallcard ->
            ...
            flatContainer s
                ...
                [ wrappedRow
                    ...
                    (allHwithIdentifiers
                        |> Dict.values
                        |> List.map (\h -> hClickableRemovableCard (View h.uuid) (Removed h.uuid) s.state.commitments allHwithIdentifiers s.state.configs h)
            ...
            flatContainer s
                ...
                [ wrappedRow
                    ...
                    [ table [ width fill, Background.color color.table.inner.background ]
                        ...
                        , columns =
                            List.map tableColumn <| List.filter (\it -> Scope.containsScope s.state.commitments s.state.commitmentTypes it.applyTo (HasType (Type.HType HType.CommitmentType))) <| Dict.values s.state.identifierTypes
                        }
                    ]
                ]
