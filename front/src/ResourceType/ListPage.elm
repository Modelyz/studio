            ...
            flatContainer s
                ...
                [ wrappedRow
                    ...
                    [ table [ width fill, Background.color color.table.inner.background ]
                        ...
                        , columns =
                            List.map tableColumn <| List.filter (\it -> Scope.containsScope s.state.resources s.state.resourceTypes it.applyTo (HasType (Type.HType HType.ResourceType))) <| Dict.values s.state.identifierTypes
                        }
                    ]
                ]
