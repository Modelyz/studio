                    ...
                    , Effect.batch
                        [ Shared.dispatchMany s
                            (Message.AddedResourceType rt
                                ...
                                ++ List.map (\g -> Message.Grouped (Groupable.RT rt) g) (Set.toList model.groups)
                            )
...
validate m =
    Ok <| ResourceType (Type.HType HType.ResourceType) m.uuid (Maybe.map .uuid m.flatselect) Nothing
            ...
            case model.step of
                Step.Step StepType ->
                    column [ alignTop, spacing 10, width <| minimum 200 fill ]
                        ...
                        , h2 "Choose the type of the new ResourceType (it can be hierarchical"
