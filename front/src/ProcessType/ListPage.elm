...
update s msg model =
    case msg of
        ...
        View uuid ->
            ( model, Route.redirect s.navkey (Route.Entity Route.ProcessType (Route.View {uuid = Uuid.toString uuid, type_ = Nothing})) |> Effect.fromCmd )
    ...
    case model.viewtype of
        ...
        ViewType.Table ->
            flatContainer s
                ...
                [ wrappedRow
                    [ spacing 10 ]
                    [ hView s.state (HasType (Type.HType HType.ProcessType)) (Dict.values s.state.resourceTypes)
                    ]
                ]
