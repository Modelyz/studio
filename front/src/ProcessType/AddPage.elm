...
match route =
    case route of
        Route.Entity Route.ProcessType Route.Add ->
            Just { route = route, uuid = Nothing }

        Route.Entity Route.ProcessType (Route.Edit uuid) ->
            ...
            case validate model of
                Ok t ->
                    ...
                    , Effect.batch
                        ...
                        , redirect s.navkey (Route.Entity Route.ProcessType (Route.View (Uuid.toString model.uuid))) |> Effect.fromCmd
                        ]
                    )
