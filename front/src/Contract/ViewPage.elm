...
match route =
    case route of
        Route.Entity Route.Contract (Route.View uuid tuuid) ->
...
update s msg model =
    case msg of
        Close ->
            ( model, Effect.fromCmd <| redirect s.navkey <| Route.Entity Route.Contract <| Route.List (Maybe.map Uuid.toString model.type_) )

        Edit ->
            ( model, Effect.fromCmd <| redirect s.navkey <| Route.Entity Route.Contract <| Route.Edit (Uuid.toString model.uuid) (Maybe.map Uuid.toString model.type_) )
