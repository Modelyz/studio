...
init s f =
    let
        ...
        adding =
            ...
            , uuid = newUuid
            , seed = newSeed
            , identifiers = initIdentifiers s.state.contracts s.state.contractTypes s.state.identifierTypes hereType Nothing newUuid
    ...
    ( f.uuid
        ...
        |> Maybe.map
            (\t ->
                ...
                in
                { adding
                    | flatselect = H.find s.state.contractTypes t.type_
                    , uuid = t.uuid
                    , identifiers =
