...
init s f =
    let
        ...
        adding =
            ...
            , uuid = newUuid
            , seed = newSeed
            , identifiers = initIdentifiers s.state.agents s.state.agentTypes s.state.identifierTypes hereType Nothing newUuid
    ...
    ( f.uuid
        ...
        |> Maybe.map
            (\t ->
                ...
                in
                { adding
                    | flatselect = H.find s.state.agentTypes t.type_
                    , uuid = t.uuid
                    , identifiers =
