...
match route =
    case route of
        Route.Entity Route.Agent (Route.List tuuid) ->
...
update s msg model =
    case msg of
        ...
        View uuid ->
            ( model, Route.redirect s.navkey (Route.Entity Route.Agent (Route.View (Uuid.toString uuid) (Maybe.map Uuid.toString model.filter))) |> Effect.fromCmd )
    ...
    case model.viewtype of
        ...
        ViewType.Table ->
            flatContainer s
                ...
                [ wrappedRow
                    [ spacing 10 ]
                    [ tView s (HasType (Type.TType TType.Agent)) entities
                    ]
                ]
